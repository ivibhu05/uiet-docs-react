...
//import Mohit from '../assests/mohits.png'
export default function Notes() {
  return (
    <div >
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-10 mx-auto">
          <h1 className="sm:text-3xl text-2xl text-center font-medium title-font mb-4 text-gray-900">Top Alumni</h1>
          {/* <div className="flex flex-col text-center w-full mb-20">
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Top Alumni</h1>
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them.</p>
      </div> */}
          <div className="flex flex-wrap -m-2 ">
            <div className=" p-2 lg:w-1/3 md:w-1/2 w-full">
              <div style={{ backgroundColor: "white" }} className="h-full flex items-center border-gray-200 border p-3 rounded-lg">

                <div className="flex-grow">
                  <h2 className="text-gray-900 title-font font-medium ">Mohit Rai</h2>
                  <p className="text-gray-500">SDE @ Flipkart</p>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <Link href="https://www.linkedin.com/in/dheerajpandey1/" className="text-white ml-1" rel="noopener noreferrer" target="_blank">@ Dheeraj</Link>
                  {/* <h2 className="text-gray-900 title-font font-medium">Akash Verma</h2> */}
                  <p className="text-gray-500">SDE @ Peritus.ai</p>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
