...
export default function Footer1() {
  return (
    <div style={{ position: 'relative', bottom: 0, right: 0, left: 0, backgroundColor: "rgb(128,0,0" }}>
      <footer className="text-gray-600 body-font">
        ...
        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
            ...
            <span className="ml-3 text-xl text-white hover:text-blue-800">UIET DOCS</span>
          </Link>
          <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">Copyright © UIET Docs —
            <Link href="https://twitter.com/knyttneve" className="text-white ml-1 " rel="noopener noreferrer" target="_blank">@ Dheeraj</Link>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-8 justify-center sm:justify-start">
            ...
            <Link className="ml-3 text-blue-500  "style={{ color: 'white' }}>
              <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={0} className="w-8 h-8 " viewBox="0 0 24 24">
                ...
                <circle cx={4} cy={4} r={2} stroke="none" className="animate-bounce" />
              </svg>
            </Link>
          </span>
        </div>
