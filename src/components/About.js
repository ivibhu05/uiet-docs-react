...
export default function About() {
  return (
    <>
    <div>
    <button  type="button" className="inline-block bg-blue-500 px-6 py-2.5  text-white-100 font-medium text-xs leading-tight uppercase rounded hover:bg-red-800 focus:text-blue-700 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 active:text-blue-800 transition duration-300 ease-in-out">HSS-S101</button>
    </div>
