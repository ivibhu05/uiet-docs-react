          ...
          <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              ...
              <div className="flex justify-center">
                ...
                <button className="transition duration-500 ease-in-out bg-grey-500 hover:bg-blue-500 transform hover:-translate-y-1 hover:scale-110 ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">
                  Button
                </button>
              </div>
            </div>
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-12">
              ...
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                You Can Drop Your Ideas And Feedback Here
              </p>
            </div>
